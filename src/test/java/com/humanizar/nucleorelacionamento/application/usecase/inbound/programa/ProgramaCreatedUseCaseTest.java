...
class ProgramaCreatedUseCaseTest {
    ...
    @InjectMocks
    private ProgramaCreatedUseCase useCase;

    @Test
    void shouldValidateAndCreateAbordagens() {
        ...
        verify(payloadValidator).validateCreated(payload, correlationId.toString());
        verify(abordagemPatientService).createAbordagens(payload, correlationId);
