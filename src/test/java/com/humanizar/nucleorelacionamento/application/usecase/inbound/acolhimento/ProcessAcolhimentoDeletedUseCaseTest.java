...
class ProcessAcolhimentoDeletedUseCaseTest {
        ...
        @InjectMocks
        private AcolhimentoDeletedUseCase useCase;
        ...
        void shouldValidateAndDeleteByPatientId() {
                ...
                AcolhimentoDeletedDTO command = new AcolhimentoDeletedDTO(patientId);
                ...
                verify(nucleoPatientService).deleteAllNucleosByPatientId(
                                patientId,
                                correlationId,
                                actorId,
                                "JUnit",
