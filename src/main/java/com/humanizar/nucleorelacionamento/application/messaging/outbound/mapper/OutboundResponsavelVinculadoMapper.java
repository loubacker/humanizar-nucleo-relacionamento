...
@Component
public class OutboundResponsavelVinculadoMapper {

    private static final String PRODUCER_SERVICE = "humanizar-nucleo-relacionamento";

    public OutboundEnvelopeDTO<OutboundResponsavelVinculadoDTO> toEnvelope(
            UUID eventId,
            UUID correlationId,
            UUID actorId,
            String userAgent,
            String originIp,
            OutboundResponsavelVinculadoDTO payload) {
